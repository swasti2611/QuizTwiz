...
const getCoins = "https://playerstorage.b-cdn.net/quiztwiz/assets/adpic.png";
const GetCoin = ({ isOpen, onClose, onClaim, adViewedComplete }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex bg-[#111827] border-2 border-white text-white flex-col justify-center items-center mx-4  p-8  rounded-[1.5rem] lg:w-full w-[40%]">
        ...
        {!adViewedComplete ? (
          <>
            <img src={getCoins} alt="reward logo" loading="lazy" />

            <h2 className="text-4xl text-[#D8E91E] md:text-[1.5rem] mb-4">
              oops!
            </h2>
