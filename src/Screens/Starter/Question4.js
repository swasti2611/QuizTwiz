...
import AdContainer2 from "../../AdContainer2";
...
function Question4() {
  ...
  const next = (key) => {
    ...
    setTimeout(() => {
      ...
      history.push(`/question/4`, routeData);
          ...
          <div className="text-white h-screen flex overflow-hidden">
            <div className="max-w-[520px] lgm:max-w-[360px] md:w-full md:min-w-full max-h-screen flex flex-col gap-3 py-3 px-2 items-center overflow-y-auto scrollhide box-border">
              ...
              <div className="border-2 w-[100%] p-6 rounded-xl bg-white bg-opacity-10">
                ...
                <p>
                  The average American household has $137,000 in debt, including
                  mortgages, student loans, credit cards, and other loans. The
                  most common type of loan in the USA is the mortgage loan,
                  followed by the student loan.The maximum amount of student
                  loan debt that a borrower can have is $1.75 million. The
                  average interest rate on a mortgage loan is 3.25%, while the
                  average interest rate on a student loan is 5.75%. The average
                  American spends $600 per month on debt payments. The first
                  payday loan was issued in 1908 by a company called American
                  Finance Company.The highest interest rate for a payday loan in
                  the USA is 400%. The shortest term for a payday loan in the
                  USA is two weeks.
                </p>
              </div>
            </div>
