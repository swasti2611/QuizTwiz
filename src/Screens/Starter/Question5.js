...
function Question5() {
  ...
  const next = (key) => {
    ...
    setTimeout(() => {
      ...
      history.push(`/question/5`, routeData);
          ...
          <div className="text-white h-screen flex overflow-hidden">
            <div className="max-w-[520px] lgm:max-w-[360px] md:w-full md:min-w-full max-h-screen flex flex-col gap-3 py-3 px-2 items-center overflow-y-auto scrollhide box-border">
              ...
              <div className="border-2 w-[100%] p-6 rounded-xl bg-white bg-opacity-10">
                ...
                <p>
                  The first online marketplace, Boston Computer Exchange, opened
                  for business in 1982.Amazon was founded in 1994, and it
                  quickly became the dominant force in e-commerce.In 2022,
                  e-commerce sales in the USA reached $875 billion.The average
                  American spends $1,200 per year on online shopping. The most
                  popular product categories for online shopping are clothing,
                  electronics, and home goods. The most popular mobile payment
                  methods are PayPal, Venmo, and Apple Pay.E-commerce is
                  expected to continue to grow in the coming years, and it is
                  projected to reach $1.3 trillion in sales by 2025.
                </p>
              </div>
            </div>
            <SidePoster />
